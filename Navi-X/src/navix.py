...
# v2.9 by rodejo (rodejo16@gmail.com)
#
...
#
# Changelog (v2.9)
# -Improved shoutcast parser. Retry mechanism added.
# -Solved browse button failure
# -Added skin media type. Allows installation of skins
# -Added setting of media type of rss feed file
# -Added setting of processor of plx and rss feed file
# -Updated the processor code
# -RSS: Use the link attribute in case the processor has been set.
# -Textview: Implemented text scrolling down/up.
# -Player: Solved play autonext in XBMC 9.04
# -Installer: Solved script/plugin installer i XBMC 9.04
#
#############################################################################
...
#                    if self.access == False:
        ...
        def getPlEntryThumb(self, mediaitem):          
            if mediaitem.type == 'rss_flickr_daily':
                type = 'rss'
            elif mediaitem.type == 'xml_applemovie':
                type = 'playlist'
            elif mediaitem.type == 'html_youtube':
                type = 'playlist'
            elif mediaitem.type == 'xml_shoutcast':
                type = 'playlist'
            elif mediaitem.type == 'directory':
                type = 'playlist'
            elif mediaitem.type[0:6] == 'script':
                type = 'script'               
            elif mediaitem.type[0:6] == 'plugin':
                type = 'script'
            elif mediaitem.type == 'skin':
                type = 'script'                
            elif mediaitem.type[0:6] == 'search':
                type = 'search'
            elif mediaitem.type[0:3] == 'rss':
                type = 'rss'                
            else:
                type = mediaitem.type

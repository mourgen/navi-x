...
#
#type=script
#name=Youtube Patch for Navi-X 2.3. Restart Navi-X after download!
#thumb=default
#URL=http://navi-x.googlecode.com/svn/trunk/Playlists/scripts/Navi-X_v23p1.zip
#
type=playlist
name=Worldwide
...
type=playlist
name=Italy
URL=http://navi-x.googlecode.com/svn/trunk/Playlists/youtube/IT/youtube.plx
#
type=playlist
name=Spain

...
title=Navi-X Home
description=Navi-X website not available. You are connected to the backup server./description
logo=none
...
thumb=default
URL=http://navi-x.googlecode.com/svn/trunk/Playlists/tips/tips.plx
#
type=playlist
name=Examples
thumb=default
...
#
type=text
name=Navi-X users Top 10 countries...
thumb=default
...
thumb=default
URL=http://navi-x.googlecode.com/svn/trunk/Playlists/donations.txt
#
